...
/*   Updated: 2025/06/09 10:34:54 by yujin            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	handle_output_redirection(t_shell *shell_program, s_redict *redirection)
{
	int	fd;
...
/* Redirection >>
 * Returns 0 on success, 1 on error*/
int	handle_append_redirection(t_shell *shell_program, s_redict *redirection)
{
	int	fd;
...
/*Redirection <
 * Returns 0 on success, 1 on error*/
int	handle_input_redirection(t_shell *shell_program, s_redict *redirection)
{
	int	fd;
...
static int	handle_heredoc_redirection(t_shell *shell_program, s_redict *redir)
{
	int	heredoc_fd;
